...
struct DecompileCommand {
    #[command(subcommand)]
    command: DecompileSubcommand,
}

#[derive(Subcommand)]
enum DecompileSubcommand {
...
struct DecompileModuleArgs {
    ...
    decompiler_args: Vec<String>,
}

#[derive(Args)]
struct DecompileAddressArgs {
    address: String,
    #[arg(long = "module")]
    modules: Vec<String>,
    #[arg(long = "decompiler-bin")]
...
fn run_decompile(rpc_url: &str, command: DecompileCommand) -> Result<()> {
    match command.command {
